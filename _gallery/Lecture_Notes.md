...
Below is a collection of my LaTeX notes, kept up to date and organized chronologically. These notes were originally typed during lectures, with only minor refinements and edits made afterwards. Any errors that may appear are most likely my own.

Each cover page includes relevant information such as the instructor for the semester and the primary textbook.

If any copyright concerns arise, please contact me at uofteric.wu@mail.utoronto.ca. I will take immediate and appropriate action to ensure full compliance

---

# Summer 2025
- [Linear Algebra II](/assets/pdf/lecture_notes/Linear_Algebra_II.pdf)
- [Intermediate Microeconomics II](/assets/pdf/lecture_notes/Micro_II.pdf)
- [Intermediate Macroeconomics II](/assets/pdf/lecture_notes/Macro_II.pdf)
- [Introductory Regression Analysis](/assets/pdf/lecture_notes/Intro_Reg.pdf)
